...
```{python}
# If the dataset wasn't loaded above, stop now with a helpful message rather
# than letting later cells fail with 'NoneType' errors.
if 'df' not in globals() or df is None:
  raise RuntimeError(
    "Dataset not found at data/lightcast_job_postings.csv. "
    "Place the dataset in the `data/` folder or update the path before rendering."
  )
